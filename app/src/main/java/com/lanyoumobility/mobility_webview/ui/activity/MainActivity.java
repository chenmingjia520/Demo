...
import com.lanyoumobility.mobility_webview.BaseActivity;
...
//        mWebView.loadUrl(Config.getRoorUrl(MainActivity.this));
//        showLoadings("加载中...");
    }
    ...
    public void saveImageInfo() {
        ...
        if(mWebView!=null&&!isLoding){
            L.log(TAG,"开始保存信息....");
            L.log("saveImageInfoAAA","开始存储::111111::::::::::::"+System.currentTimeMillis());
